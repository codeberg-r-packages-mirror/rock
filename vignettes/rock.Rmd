...
Codes in a flat or hierarchical organizational mode are in blue blocks again; value codes (for magnitude coding) are in yellow blocks; and class instance identifiers are in pink blocks. Utterance identifiers are in grey blocks (see [rock::prepending_uids]), section breaks (used for segmentation) have a light blue/purplish background. Finally, embedded YAML chunks have a green background.
